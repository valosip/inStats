...
- (IBAction)refreshTrigered:(id)sender {
...
-(void) prepareToRock{
    ...
    self.instaObjectsArray = [self.machine sortByLikesHighToLow];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    sortLikesTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"reuseHighLowCell" forIndexPath:indexPath];
